...
<head>
    ...
    <title>Page Expired - Connected Performance</title>
    <link rel="icon" type="image/x-icon" href="https://crm.connected-performance.com/custom/img/connect_logo.png">
</head>
<style>
    .padding {
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <p>The url has expired and is no longer available. If you wish to carry out the process, contact the Connected Performance team</p>
                                    </div>
                                </div>
                            </div>
                        </div>
