...
<style>
    .main-menu.menu-light .navigation>li ul .active {
        background: linear-gradient(118deg, #28c76f, rgb(40 199 111));
        box-shadow: 0 0 10px 1px rgb(40 199 111);
        border-radius: 4px;
        z-index: 1;
    }
    ...
    .bs-stepper .bs-stepper-header .step.active .step-trigger .bs-stepper-box {
        background-color: #28c76f;
        color: #fff;
        box-shadow: 0 3px 6px 0 rgb(40 199 111);
    }
    ...
    .bs-stepper .bs-stepper-header .step.crossed .step-trigger .bs-stepper-box {
        background-color: rgb(40 199 111 / 19%);
        color: #28c76f !important;
    }
        ...
        <ul class="nav navbar-nav flex-row">
            <li class="nav-item ">
                <a class="navbar-brand" href="{{ url('/') }}">
                    <img src="{{ URL::asset('custom/img/connect_logo.png') }}" class="" height="60">
                ...
                @foreach ($sidebarMenu as $menu)
                    ...
                    @else
                        ...
                        @php
                            ...
                            $data = session()->get('permissions');
                        @endphp

                        @if (auth()->user()->hasPermission($menu->access))
                            {{-- {{  $menu->access}} --}}
                            <li
