        ...
        <div class="row">
                    ...
                    <div class="card-body">
                        <div class="user-avatar-section">
                            <div class="d-flex align-items-center flex-column">
                                <img class="img-fluid rounded mt-3 mb-2" src="public/users/.{{ @$users->avatar }}" height="110"
            ...
            <div class="col-xl-8 col-lg-7 col-md-7 order-0 order-md-1">
                ...
                <ul class="nav nav-pills mb-2">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="{{ route('account.secuirty') }}">
                            <i data-feather="lock" class="font-medium-3 me-50"></i>
                            <span class="fw-bold">Security</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('account.billing.plan') }}">
