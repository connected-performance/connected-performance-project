                    ...
                    <div class="card-body">
                        ...
                        <div class="info-container">
                            ...
                            <div class="d-flex justify-content-center pt-2">
                                <a href="javascript:;" class="btn btn-success me-1" data-bs-target="#editUser"
      ...
      <div class="card border-success">
        <div class="card-body">
          <div class="d-flex justify-content-between align-items-start">
            <span class="badge bg-light-success">Standard</span>
            <div class="d-flex justify-content-center">
              <sup class="h5 pricing-currency text-success mt-1 mb-0">$</sup>
              <span class="fw-bolder display-5 mb-0 text-success">99</span>
    ...
    <div class="col-xl-8 col-lg-7 col-md-7 order-0 order-md-1">
      <!-- User Pills -->
              <ul class="nav nav-pills mb-2">
                    ...
                    <li class="nav-item">
                        <a class="nav-link " href="{{ route('account.secuirty') }}">
                            <i data-feather="lock" class="font-medium-3 me-50"></i>
                            <span class="fw-bold">Security</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="{{ route('account.billing.plan') }}">
                            <i data-feather="bookmark" class="font-medium-3 me-50"></i>
                            <span class="fw-bold">Billing & Plans</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('account.notification') }}">
                            <i data-feather="bell" class="font-medium-3 me-50"></i><span
                                class="fw-bold">Notifications</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('account.connection') }}">
          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <div class="mb-2 mb-md-1">
                <h5>$199 Per Month <span class="badge badge-light-success ms-50">Popular</span></h5>
            ...
            <div class="col-12">
              <button class="btn btn-success me-1 mt-1" data-bs-toggle="modal" data-bs-target="#upgradePlanModal">
                Upgrade Plan
              </button>
      ...
      <div class="card">
        <div class="card-header">
          ...
          <button class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#addNewCard">
              ...
              <div class="d-flex justify-content-between flex-sm-row flex-column">
                <div class="card-information">
                  ...
                  <div class="d-flex align-items-center mb-50">
                    ...
                    <span class="badge badge-light-success ms-50">success</span>
                  </div>
                  <span class="card-number">∗∗∗∗ ∗∗∗∗ 9856</span>
                </div>
                <div class="d-flex flex-column text-start text-lg-end">
                  <div class="d-flex order-sm-0 order-1 mt-1 mt-sm-0">
                    <button class="btn btn-outline-success me-75" data-bs-toggle="modal" data-bs-target="#editCard">
                      Edit
                    </button>
      ...
      <div class="card">
        <div class="card-header">
          ...
          <button
            class="btn btn-success btn-sm edit-address"
            type="button"
            data-bs-toggle="modal"
