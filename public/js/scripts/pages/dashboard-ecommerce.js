...
//     $.ajax({
//         url: "/panel/revenue/ajax",
//         type: 'POST',
//         success: function(response){

//             var data = $.parseJSON(response.data);
//             $.each(data, function(index, value) {
//                 cahrtvalue.push(value);
//             });
//             console.log(cahrtvalue);
//         }
//     });
// });
...
'use strict';
  ...
  setTimeout(function () {
    toastr['success'](
      'You have successfully logged in connect-performance-crm !',
      '👋 Welcome!',
      {
        closeButton: true,
        tapToDismiss: false,
...
//       {
//         name: 'Earning',
//         // data: cahrtvalue.length ? cahrtvalue : [95, 177, 284, 256, 105, 63, 168, 218, 72]
//         data: cahrtvalue
//       },
//       {
//         name: 'Expense',
//         data: [-145, -80, -60, -180, -100, -60, -85, -75, -100, -68, -35, -79]
//       }
//     ],
//     dataLabels: {
//       enabled: false
...
//   };
    ...
    return new Promise((resolve, reject) => {
      $.ajax({
        ...
        success: function(response){
            ...
            var count = $.parseJSON(response.count);
  ...
  loadData().then((data) => {
    ...
    // Use data variable to initialize chart
  }).catch((error) => {
    console.log(error);
  });
  ...
  //   }
  // };
  // goalOverviewChart = new ApexCharts($goalOverviewCharts, goalOverviewChartOptions);
