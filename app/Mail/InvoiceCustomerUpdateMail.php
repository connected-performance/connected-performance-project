...
class InvoiceCustomerUpdateMail extends Mailable
{
    ...
    public function build()
    {
        ...
        $buttton  = '<a href="http://127.0.0.1/connect_permormance_gitlab/public/customer-update-information/'.$user->uid.'" style="background-color: rgb(0, 108, 152); padding: 2%; padding-left: 10%;  padding-right: 10%;border-radius: 10px;border: none; color:#fff;">Update Information</a>';
